...
# Función para sugerencias Google Places
...
# Inputs con autocompletado "popup" simulado en el mismo input
st.markdown("### Selección de Destinos con Autocompletado")

origin = st.text_input("Origen (Ej. Four Seasons Tokyo)")
if origin:
...
# Mostrar mapa inmediatamente después de origen/destino
...
if submitted:
    if not origin or not destination or not fecha:
        ...
        st.info("Calculando ruta y tarifa...")
